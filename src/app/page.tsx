  ...
  return (
    <main>
      <section className="relative flex min-h-svh items-center overflow-hidden bg-ink text-chalk">
        <div className="absolute inset-y-0 right-0 hidden w-1/3 bg-amber md:block" aria-hidden="true" />
        <div className="relative mx-auto grid w-full max-w-6xl gap-12 px-5 py-16 md:grid-cols-[1.15fr_0.85fr] md:px-8 md:py-20">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-chalk/75">
          ...
          <ul className="relative z-10 grid content-center gap-4 self-center rounded-3xl bg-ink-soft p-6 md:p-8">
            {[
              ...
              <li
                key={item}
                className="border-b border-white/10 pb-4 text-lg last:border-none last:pb-0"
              >
                {item}
              </li>
            ))}
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-5 py-20 md:grid-cols-2 md:px-8">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.16em] text-amber">
            Why custom
          </p>
